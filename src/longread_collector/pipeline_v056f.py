...
# Enrich only explicitly supported section routes with publication time that is
# directly displayed on the list page. This does not add requests or change the
