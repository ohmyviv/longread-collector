"""PR-7.3.3 Canonical Article wrapper for title-local metadata recovery.

PR-7.3.3 remains L4-only. It keeps PR-7.3.2 publication/source behavior and adds
narrow title-local byline-date plus self-source recovery. L5/L6 semantics remain
unchanged.
"""
...
from .publication_v0733 import PUBLICATION_VERSION, resolve_publication
from .service_v0731 import _age_days, _strip_demoted_url_date_projections
from .service_v0732 import CanonicalArticleResolver as _PR732CanonicalArticleResolver
from .source_resolution_v0733 import SOURCE_VERSION, resolve_source

CANONICAL_SERVICE_VERSION = "canonical-article-resolver-v0.6-pr7.3.3"


class CanonicalArticleResolver(_PR732CanonicalArticleResolver):
    """Resolve PR-7.3.3 L4 evidence over the PR-7.3.2 base."""
