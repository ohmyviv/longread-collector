"""PR-7.3.9 Canonical Article wrapper for L4 source-evidence recovery.

Publication stays frozen at PR-7.3.7, PageSurface at PR-7.3.4, and snapshot
persistence at PR-7.3.8. This wrapper re-resolves only source facts from already-
acquired evidence and preserves all downstream L5/L6 behavior.
"""
...
from .service_v0738 import CanonicalArticleResolver as _PR738CanonicalArticleResolver
from .source_resolution_v0739 import SOURCE_VERSION, resolve_source

CANONICAL_SERVICE_VERSION = "canonical-article-resolver-v0.6-pr7.3.9"


class CanonicalArticleResolver(_PR738CanonicalArticleResolver):
    """Apply PR-7.3.9 source evidence over the PR-7.3.8 L4 base."""
