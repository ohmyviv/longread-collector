"""v0.5.6m prefilter with magazine-issue landing-page rejection."""
...
from .page_gate_policy_v056m import (
    PAGE_GATE_POLICY_VERSION,
    evaluate_page_gate_policy_v056m,
)
from .ranked_freshness_v056 import RANKING_FRESHNESS_VERSION
from .ranked_selection_plan_v056 import filter_discovered as _reserve_filter_discovered

PREFILTER_VERSION = "page-freshness-prefilter-v0.5.6m"
...
def filter_discovered_v056m(
    ...
    *,
    ...
    for item in discovered:
        page = evaluate_page_gate_policy_v056m(item)
        if page.rejected:
        ...
        item.metadata.setdefault("selection", {}).update(
            {
                ...
                "published_at_source": evidence.get(
...
__all__ = ["PREFILTER_VERSION", "filter_discovered_v056m"]
